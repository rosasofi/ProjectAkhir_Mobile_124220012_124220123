...
class _CoffeeShopHoursConversionState extends State<CoffeeShopHoursConversion> {
  ...
  String getMenuRecommendation() {
    ...
    if (hour < 10) {
      return "Recommended: Cappuccino Coffee for breakfast!";
    } else if (hour >= 10 && hour < 14) {
      return "Recommended: Iced Latte  for lunch!";
    } else if (hour >= 14 && hour < 18) {
      return "Recommended: Cappuccino for your afternoon break!";
    } else {
      return "Recommended: Hot Chocolate  for a cozy evening!";
    }
  }
